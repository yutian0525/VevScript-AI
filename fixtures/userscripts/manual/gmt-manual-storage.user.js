...
(function () {
  ...
  GMT.render({
    ...
    title: 'GM 手测·值存储',
    cards: [
      { id: 's1', api: 'GM_info', desc: '脚本与扩展元数据（scriptHandler/version/script/injectInto）。', steps: ['核对下方日志里的 script.name 是否为本脚本名、scriptHandler 是否为 vevscript-ai'], expect: '字段与本脚本元头一致' },
